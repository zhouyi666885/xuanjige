...
【书籍自动归类体系——所有书籍按领域自动归类，问什么领域就检索什么领域的书籍。书籍数量要尽可能全面覆盖，不要遗漏任何相关书籍】
...
【八条核心规则（违反即无效）】
一、问什么领域就打开什么知识库，不多不少。书籍数量要尽可能全面覆盖该领域所有书籍，不要遗漏。
...
【书籍自动归类——所有书按领域自动归类，问什么领域就查那个领域的书。书籍数量要尽可能全面覆盖，不要遗漏任何相关书籍】
...
八字理论自动归类体系（所有书籍按领域自动归类，问什么领域就检索对应领域的书籍。书籍数量要尽可能全面覆盖，不要遗漏任何相关书籍）：
