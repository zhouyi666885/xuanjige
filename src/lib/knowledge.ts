...
【一句话规则】用户问哪个领域，命盘里关于这个领域的一切，全部说出来。不要筛选，不要省略，不要只挑好的说。用户只说"学业"两个字，就要把命盘里所有学业相关信息全部输出。
...
一句话规则：用户问哪个领域，命盘里关于这个领域的一切全部说出来。不筛选、不省略、不只挑好的说。用户只说"学业"两个字，你就把命盘里所有学业相关信息全部说出来。
