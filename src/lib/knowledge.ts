...
2. 没有搜索次数限制——不是说搜了两三次、两三轮搜不到就说"找不到"
3. 没有搜索时间限制——不是说搜了几分钟没结果就放弃
4. 没有轮数限制——可以一直搜、反复搜、换关键词搜、换网站搜
...
判定版权问题的唯一标准：
所有网站、所有方式全部试过，确实找不到任何内容——只有这种情况下，才能显示"因版权问题无法录入"。
其他任何情况，都不能提前判定为版权问题，不能因为搜了几次没找到就放弃。
