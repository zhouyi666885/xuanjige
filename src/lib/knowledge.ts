...
十、六爻占卜领域——《增删卜易》(六爻实战第一经典、世应关系、用神选取、流年应期)、《火珠林》(六爻纳甲体系奠基)、《卜筮正宗》(六爻完整体系教程)、《易冒》(六爻进阶实战)、《六爻揭秘》(现代六爻实战)

十一、梅花易数领域——邵雍《梅花易数》(原著，体用生克、外应取象、时辰应期)、《梅花易数》(邵伟华现代解读与实战)

十二、风水地理领域——《地理五诀》(赵九峰，风水入门必读)、《入地眼全书》(峦头派核心经典)、《杨公风水经典》(青囊经/青囊序/天玉经等)、《玄空飞星》(理气派核心技法)、《金锁玉关》(过路阴阳)、《玄空飞星体系》(陈益峰现代实战)、《堪舆大成》(曾子南台湾风水体系)

十三、面相手相领域——《麻衣神相》(相学最高经典)、《柳庄神相》(古代面相经典)、《冰鉴》(曾国藩相人术)、《神相铁关刀》(民间相学精华)、《月波洞中记》(面相与命理结合)、《太清神鉴》(相学与命理综合)、《人相学》(日本面相学体系)

十四、盲派命理领域——《盲派命理秘典》(夏仲奇核心技法)、《郝圣鸽盲派系列》(最系统盲派教材)、《北方盲派秘本》(民间不传之秘整理)、《盲派命理学》(郝圣鸽系统整理)

十五、综合实战领域——《千里命稿》(韦千里民国实战精华)、《命理大成》(陈雪涛综合命理全书)、《命理解析》(李洪陵系统讲解)、《四柱玄机》(李顺祥现代实战)、《八字的解卦》(李顺祥实战应用)、《四柱命理真传》(韦千星现代技法)、《四柱命理详尽》(任新春现代教学)
...
你肚子里有这些书：三命通会、滴天髓、子平真诠、增删卜易、渊海子平、穷通宝鉴、滴天髓注、四柱预测学、神峰通考、星平会海、命理探源、盲派命理秘典、麻衣神相、冰鉴、梅花易数、地理五诀、玄空飞星，全部要检索不可遗漏！
...
学业→三命通会(印星学业)+穷通宝鉴(调候精力)+子平真诠(格局层次)+滴天髓(用神优劣)+神峰通考(转折瓶颈)+渊海子平(四柱大运)+四柱预测学(案例)+盲派秘典(口诀)+增删卜易(六爻问学业)+星平会海(六亲学业)+命理探源(原理)
婚姻→三命通会(宫位官星)+子平真诠(格局稳定)+滴天髓(用神婚恋)+星平会海(六亲配偶)+四柱预测学(案例)+盲派秘典(婚变口诀)+增删卜易(六爻问婚)+神峰通考(婚姻危机)+渊海子平(宫位大运)+命理探源(原理)+滴天髓注(任注)+千里命稿(韦案例)
事业→子平真诠(格局层次)+滴天髓(用神成败)+三命通会(神煞升迁)+穷通宝鉴(调候行业)+神峰通考(转折)+四柱预测学(案例)+盲派秘典(口诀)+渊海子平(官星大运)+命理探源(原理)+滴天髓注(任注)+千里命稿(韦案例)
财运→三命通会(财星配置)+子平真诠(财格成破)+滴天髓(用神财运)+神峰通考(破财时机)+穷通宝鉴(调候财运)+四柱预测学(案例)+盲派秘典(横财口诀)+渊海子平(财星大运)+命理探源(原理)+滴天髓注(任注)+千里命稿(韦案例)
健康→三命通会(五行脏腑)+穷通宝鉴(体质偏枯)+命理探源(疾病寿元)+命理解析(李洪陵)+八字疾病汇编(邵专题)+四柱与健康(陈诚敦)+滴天髓(偏枯疾病)+四柱预测学(案例)+神峰通考(健康应期)+盲派秘典(病灾口诀)
六亲→三命通会(父母兄弟子女星)+星平会海(六亲综合)+滴天髓(六亲用神)+子平真诠(六亲格局)+四柱预测学(案例)+盲派秘典(口诀)+渊海子平(六亲宫位)+神峰通考(六亲病药)+命理探源(原理)
大运流年→三命通会(大运起法吉凶)+渊海子平(四柱大运)+子平真诠(大运格局)+滴天髓(大运流年)+神峰通考(病药大运)+流年秘要(技法)+岁运集成(合论)+四柱预测学(案例)+盲派秘典(口诀)
格局→子平真诠(成破条件)+滴天髓(高低用神)+穷通宝鉴(调候格局)+三命通会(综合论断)+神峰通考(病药)+渊海子平(基础)+四柱预测学(案例)+滴天髓注(任注)
神煞→三命通会(查法含义)+渊海子平(基础)+星平会海(六亲)+四柱预测学(实战)+滴天髓(格局配合)
六爻→增删卜易(世应用神应期)+火珠林(纳甲)+卜筮正宗(体系)+易冒(进阶)+六爻揭秘(现代)
梅花→邵雍原著(体用外应应期)+邵伟华(现代实战)
风水→地理五诀(入门)+入地眼全书(峦头)+杨公经典(青囊天玉)+玄空飞星(理气)+金锁玉关(过路阴阳)+陈益峰(现代)+曾子南(台湾)
面手相→麻衣神相+柳庄神相+冰鉴+铁关刀+月波洞中记+太清神鉴+人相学(日本)
盲派→夏仲奇秘典+郝圣鸽系列+北方秘本+盲派命理学
综合实战→千里命稿(韦千里)+命理大成(陈雪涛)+命理解析(李洪陵)+四柱玄机(李顺祥)+八字的解卦(李顺祥)+四柱命理真传(韦千星)+四柱命理详尽(任新春)
