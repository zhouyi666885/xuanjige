...
一、学业：学历高低、学习能力、学业运、是否顺利、可能的学业变化
二、事业：事业方向、工作运势、事业层次、事业变动、适合职业
三、婚姻：婚姻早晚、配偶情况、婚姻运、感情经历、婚姻质量
四、财运：财运层次、赚钱能力、理财运势、破财信号、财富积累
五、健康：体质倾向、容易生病的部位、需要注意的健康时段
六、六亲：父母情况、兄弟姐妹、子女情况、与六亲缘分
七、大运流年：按年龄阶段逐一分析每步大运的吉凶，以及关键流年的具体事件

【每个领域的输出格式】
【学业】
- 命局信号：[从八字结构得出的学业相关判断]
- 大运流年：[在什么年龄、大运、流年会有什么学业相关事件]
- 时间：[具体年份]
- 地点：[方位或场所]
- 场景：[当事人状态]
- 原因：[命局原有信号+大运引动+流年催发三层逻辑]
